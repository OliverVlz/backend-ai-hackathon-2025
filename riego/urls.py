...
from .views import (
    ...
    TipoCultivoViewSet, TipoRiegoViewSet, ZonaCultivoViewSet, CronogramaViewSet
)
...
router.register(r'zonas-cultivo', ZonaCultivoViewSet, basename='zonacultivo')
...
urlpatterns = [
    ...
    path('zonas-cultivo/<int:zona_id>/generar-cronograma/', generar_cronograma, name='generar_cronograma'),
